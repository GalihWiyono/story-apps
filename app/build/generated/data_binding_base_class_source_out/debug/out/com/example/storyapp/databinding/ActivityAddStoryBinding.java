...
public final class ActivityAddStoryBinding implements ViewBinding {
  ...
  private ActivityAddStoryBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnCamera,
      @NonNull Button btnGallery, @NonNull Button btnUpload, @NonNull EditText editDescription,
      @NonNull ImageView imgUpload, @NonNull ProgressBar loadingBar) {
  ...
  public static ActivityAddStoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.img_upload;
      ImageView imgUpload = ViewBindings.findChildViewById(rootView, id);
      if (imgUpload == null) {
        break missingId;
      }
      ...
      return new ActivityAddStoryBinding((ConstraintLayout) rootView, btnCamera, btnGallery,
          btnUpload, editDescription, imgUpload, loadingBar);
    }
