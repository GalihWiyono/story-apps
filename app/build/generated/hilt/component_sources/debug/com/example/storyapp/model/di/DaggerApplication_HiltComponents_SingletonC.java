...
import com.example.storyapp.view.ui.AddStoryActivity;
import com.example.storyapp.view.ui.DetailActivity;
import com.example.storyapp.view.ui.LoginActivity;
import com.example.storyapp.view.ui.MainActivity;
import com.example.storyapp.view.ui.MapsActivity;
import com.example.storyapp.view.ui.RegisterActivity;
import com.example.storyapp.viewmodel.StoryViewModel;
import com.example.storyapp.viewmodel.StoryViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.storyapp.viewmodel.UserViewModel;
import com.example.storyapp.viewmodel.UserViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApplication_HiltComponents_SingletonC extends Application_HiltComponents.SingletonC {
  ...
  private ApiService apiService() {
    return Module_ProvideApiServiceFactory.provideApiService(Module_ProvideRetrofitFactory.provideRetrofit());
  }
  ...
  private static final class ActivityCImpl extends Application_HiltComponents.ActivityC {
    ...
    @Override
    public void injectAddStoryActivity(AddStoryActivity arg0) {
    }
    ...
    @Override
    public void injectMapsActivity(MapsActivity arg0) {
    }
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(StoryViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(UserViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends Application_HiltComponents.ViewModelC {
    ...
    private UserPreference userPreference() {
      return new UserPreference(ApplicationContextModule_ProvideContextFactory.provideContext(singletonC.applicationContextModule));
    }

    private StoryPagingSource storyPagingSource() {
      return new StoryPagingSource(singletonC.apiService(), userPreference());
    }

    private StoryRepository storyRepository() {
      return new StoryRepository(singletonC.apiService(), storyPagingSource());
    }
    ...
    private UserRepository userRepository() {
      return new UserRepository(singletonC.apiService());
    }

    private UserViewModel userViewModel() {
      return new UserViewModel(userRepository(), userPreference());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam) {
      this.storyViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 0);
      this.userViewModelProvider = new SwitchingProvider<>(singletonC, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.example.storyapp.viewmodel.StoryViewModel", (Provider) storyViewModelProvider).put("com.example.storyapp.viewmodel.UserViewModel", (Provider) userViewModelProvider).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.storyapp.viewmodel.StoryViewModel 
          return (T) viewModelCImpl.storyViewModel();

          case 1: // com.example.storyapp.viewmodel.UserViewModel 
